      ...
      <div className="bg-white min-h-screen mt-20">
        <div className="container mx-auto py-10 px-4 md:px-72 ">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-10 mb-10 mt-4">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-center">Call For Paper</h1>
            </div>
          </div>
          ...
          <div className="bg-gray-100 shadow-md rounded-lg p-6">
            <h2 className="text-2xl md:text-3xl font-bold text-red-600 mb-4">Extended Abstract Submission:</h2>
            <p className="mb-4 text-xl md:text-2xl">The extended abstract (not over 600 words) must include research objectives, methodology, results and conclusion of the study. The submitting file should contain the following:</p>
