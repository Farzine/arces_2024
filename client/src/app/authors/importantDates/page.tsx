...
const ImportantDates: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-6 py-12 bg-white min-h-screen mt-24">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center mb-16 mt-8">
            <Calendar className="w-10 h-10 mr-4 text-gray-700 md:w-14 md:h-14" />
            <h1 className="text-3xl md:text-5xl sm:text-xl font-bold text-center text-gray-800">
              IMPORTANT DATES
            </h1>
          </div>
