...
const RegistrationFees: React.FC = () => {
    ...
    return (
        <div className='min-h-screen'>
            ...
            {/* Main Container */}
            <div className="container max-w-screen-lg mx-auto px-4 py-8 bg-white mb-10 min-h-screen mt-24 md:mt-16">
                ...
                <div className='flex flex-col md:flex-row items-center justify-center mt-14 mb-10'>
                    ...
                    />
                    <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center">REGISTRATION FEES</h1>
                </div>

                {/* Registration Button */}
                <p className="text-center text-base md:text-lg text-red-600 font-semibold mb-4 cursor-pointer hover:underline" onClick={handleRegistration}>
                    Click to Registration
                </p>

                {/* Fees Section */}
                <p className="text-start font-semibold text-xl md:text-2xl ml-8 md:ml-24 mb-4">
                    FEES:
                </p>
                ...
                <div className="mb-8 ml-4 md:ml-24">
                    <div className='flex items-center'>
                        <h2 className="text-xl md:text-2xl font-bold mb-4 text-red-600">PAYMENT DEADLINE</h2>
                        <Image
                    ...
                    <p className="flex items-center mb-4">
                        <span className="text-lg md:text-xl font-semibold">Early Bird</span>
                        <span className="ml-4 md:ml-8 text-lg md:text-xl font-semibold">Date: Dec 01-Dec 10, 2024</span>
                    </p>
                    <p className="flex items-center">
                        <span className="text-lg md:text-xl font-semibold">Regular</span>
                        <span className="ml-4 md:ml-12 text-lg md:text-xl font-semibold">Date: Dec 11-Dec 25, 2024</span>
                    </p>
                </div>

                {/* Payment System */}
                <div className="mb-8 ml-4 md:ml-24">
                    <h2 className="text-xl md:text-2xl font-bold mb-4">PAYMENT SYSTEM</h2>
                    <p className="text-blue-500 cursor-pointer mb-4 hover:underline text-base md:text-lg">Click for Details</p>
                </div>

                {/* Proceedings */}
                <div className="mb-8 ml-4 md:ml-24">
                    <h2 className="text-xl md:text-2xl font-bold mb-4 underline text-red-600">Proceedings:</h2>
                    ...
                    <p className="mb-4 text-sm md:text-base">For Adults and BDT 1000 for Children above three years.</p>
                </div>

                {/* Conference Tour */}
                <div className="mb-8 ml-4 md:ml-24">
                    <h2 className="text-xl md:text-2xl font-bold mb-4 underline text-red-600">Conference Tour:</h2>
