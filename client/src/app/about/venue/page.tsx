...
const center = {
  lat: 24.920075328606153,
  lng: 91.83172731416714,
};
...
export default function Venue() {
  ...
  // Custom marker for rendering origin and destination
  const renderMarkers = () => {
  ...
  return (
    <main className="h-full w-full">
      ...
      <div className="w-full h-full bg-white mx-auto flex flex-col items-center p-4 md:p-10">
        ...
        <h1 className="font-inter mt-5 font-semibold flex">
          Direction From your current Location
          <GiDirectionSigns className="ml-2" />
        </h1>

        {/* map */}
        <div className="google-map-sust w-full h-full drop-shadow-md flex justify-center items-center my-5">
          {isLoaded ? (
            <GoogleMap
